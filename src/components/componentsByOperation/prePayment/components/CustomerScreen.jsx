...
export const CustomerScreen = ({ meterSearchResult, setMeterSearchResult }) => {
    ...
    return (
        <div className='container border rounded flex-grow-1 mt-1'>
                        ...
                        <div className="d-flex justify-content-between cash-div-custom div-small-height container">
                            <div className="col-auto">
                                <div className="input-group mb-3">
                                    <select className="form-select input-extra-small m-1" id="inputGroupSelect01"
                                            name="selectedOption"
