...
export const TreeComponent = () => {
    ...
    return (
        <div className={`row ${isVisible ? '' : 'hidden'}`}>
                                    ...
                                    <div className="accordion-item">
                                        ...
                                        <div id="flush-collapseEscritorioComercial"
                                            ...
                                            <div className="d-grid gap-2 mx-auto mt-3">
                                                ...
                                                <a className="btn tree-btn-custom" type="button">Cancelamiento de
                                                    pagamento</a>
                                                <a className="btn tree-btn-custom" type="button">A falta de
                                                    pagamento</a>
                                                <a className="btn tree-btn-custom" type="button">Plano de prestação</a>
                                                <a className="btn tree-btn-custom" type="button">Late Payment
                                                    adjustment</a>
                                                <a className="btn tree-btn-custom" type="button">Estado de Caixa</a>
                                                <a className="btn tree-btn-custom" type="button">Abrir / Fechar
                                                    caixa</a>
                                                <a className="btn tree-btn-custom" type="button">Transacçõnes de
                                                    Caixa</a>
                                                <a className="btn tree-btn-custom" type="button">Histórico de
                                                    Transacçõnes
                                                    de Caixa</a>
                                                <a className="btn tree-btn-custom" type="button">Bank Deposits
                                                    Inquiries</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="accordion-item">
                                        <h2 className="accordion-header">
                                            <button className="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse"
                                                    data-bs-target="#flush-collapsePrePagamento"
                                                    aria-expanded="false" aria-controls="flush-collapsePrePagamento">
                                                Pré-pagamento
                                            </button>
                                        </h2>
                                        <div id="flush-collapsePrePagamento" className="accordion-collapse collapse"
                                             data-bs-parent="#accordionFlushExample">
